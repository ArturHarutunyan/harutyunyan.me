...
function initClient() {
	gapi.auth2.init({apiKey: apiKey, client_id: clientId, scope: scopes})
	.then(function(a) {
		console.log(a);
...
function handleLocationReviews() {
	var url = gmb_api_version + '/locations/ChIJF5QjNGuMsUcRCLir6MPxVcg/reviews';

	XHRequest('GET', url).then(function(...a){console.log(a)});
}
