    ...
    if ($('#home-section').length) {
        $(window).on('scroll', function() {
            ...
            $('.top-menu ul li a').each(function() {
                ...
                if (refElement.offset().top - 170 <= scrollPos) {
...
/* Google Map Options */
function initMap() {
    var myLatlng = new google.maps.LatLng(40.1442219,44.4626216); // <- Your latitude and longitude
    var styles = [{
            "featureType": "water",
            "stylers": [{
                    "color": "#d8dee9"
